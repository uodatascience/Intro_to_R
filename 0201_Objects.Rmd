...
(Brief aside): When using R, only objects in active memory are manipulated, not the data on the disk. So your data files are always available in their raw format, which means your analyses can be reproduces and altered without ever touching the raw data files.   
