  ---
title: "What the F#$% is R and how do I get started with it?"
...
Now that you know about *objects*, you'll want to know about *functions*. In R, we use functions to do stuff to objects. Functions take in some input, perform some operation, and then provide some output. Generally speaking, different arguments in the function are separated by a comma. We've already covered several functions:
