...
Within R, use `?functionName` or `??functionName`. The single `?` will search for a function of that name whereas `??` will use your input as a keyword to search in all R documentation.  
