...
An example may help with this. Compare this:
...
One more thing to keep in mind about this issue, is that the gains in cleanliness with pipes is greater the more complex your code is. Let's say, we had a dataset that we wanted to take a subset of cases from, and just a couple of rows from, 
