...
that looks like this:
    ...
    ##    <dbl>            <dbl>                <dbl>          <dbl>
    ##  1     1         2.609914             3.090998       3.433968
    ##  2     2         1.687102             3.765265       1.974373
    ##  3     3         2.586287             3.199526       2.938334
    ##  4     4         2.665519             1.829241       1.861557
    ##  5     5         2.645352             2.093038       3.055111
    ##  6     6         3.690846             2.628725       2.036853
    ##  7     7         3.317954             3.504026       1.598658
    ##  8     8         3.569045             2.516557       2.974917
    ##  9     9         4.642243             3.054369       3.968014
    ## 10    10         0.802873             4.786069       2.512915
    ...
    ##  $ agreeableness_t1    : num  2.61 1.69 2.59 2.67 2.65 ...
    ##  $ conscientiousness_t1: num  3.09 3.77 3.2 1.83 2.09 ...
    ##  $ neuroticism_t1      : num  3.43 1.97 2.94 1.86 3.06 ...
    ##  $ extraversion_t1     : num  4.4 3.19 2.96 3.87 2.92 ...
    ##  $ openness_t1         : num  3.6 2.84 2.9 3.3 3.23 ...
    ##  $ agreeableness_t2    : num  2.87 2.52 3.27 3.1 3.49 ...
    ##  $ conscientiousness_t2: num  3.66 4.18 3.66 2.18 2.69 ...
    ##  $ neuroticism_t2      : num  4.06 2.61 3.29 2.13 3.41 ...
    ##  $ extraversion_t2     : num  4.76 3.63 3.46 4.25 3.67 ...
    ##  $ openness_t2         : num  3.92 3.32 3.41 3.7 3.62 ...
    ##  $ agreeableness_t3    : num  3.69 2.55 3.9 3.68 3.81 ...
    ##  $ conscientiousness_t3: num  4.43 4.47 4.32 2.83 3.09 ...
    ##  $ neuroticism_t3      : num  4.48 3.23 3.77 2.52 3.94 ...
    ##  $ extraversion_t3     : num  5.23 4.2 4 4.89 3.99 ...
    ##  $ openness_t3         : num  4.58 3.69 3.96 4.48 4 ...
    ##  $ agreeableness_t4    : num  4.19 3.08 4.17 4.25 4.25 ...
    ##  $ conscientiousness_t4: num  4.55 5.22 4.78 3.23 3.67 ...
    ##  $ neuroticism_t4      : num  4.96 3.67 4.12 2.99 4.15 ...
    ##  $ extraversion_t4     : num  5.69 4.75 4.93 5.19 4.35 ...
    ##  $ openness_t4         : num  5.48 4.47 4.88 5.43 4.58 ...
...
participant at each time point, like so:
    ...
    ##    <dbl> <chr>         <chr>    <dbl>
    ##  1     1    t1 agreeableness 2.609914
    ##  2     1    t2 agreeableness 2.869869
    ##  3     1    t3 agreeableness 3.688870
    ##  4     1    t4 agreeableness 4.187579
    ##  5     2    t1 agreeableness 1.687102
    ##  6     2    t2 agreeableness 2.519115
    ##  7     2    t3 agreeableness 2.547279
    ##  8     2    t4 agreeableness 3.079208
    ##  9     3    t1 agreeableness 2.586287
    ## 10     3    t2 agreeableness 3.267412
...
important and most often mentioned reasons to use pipes are
*cleanliness* (which I hear is next to *godliness*) and efficiency. We
can think of three related advantages:
...
And say we want it to lengthen it to look like this:
    ...
    ##  1     1    t1      2.609914          3.090998     4.400030    3.433968
    ##  2     1    t2      2.869869          3.656185     4.764244    4.059142
    ##  3     1    t3      3.688870          4.434052     5.232641    4.483425
    ##  4     1    t4      4.187579          4.550137     5.685175    4.955630
    ##  5     2    t1      1.687102          3.765265     3.185300    1.974373
    ##  6     2    t2      2.519115          4.176860     3.634907    2.606403
    ##  7     2    t3      2.547279          4.472516     4.203750    3.225278
    ##  8     2    t4      3.079208          5.215599     4.745971    3.665288
    ##  9     3    t1      2.586287          3.199526     2.962318    2.938334
    ## 10     3    t2      3.267412          3.661060     3.462562    3.289745
...
but `pid`
    ...
    ##      pid         variable    score
    ##    <dbl>            <chr>    <dbl>
    ##  1     1 agreeableness_t1 2.609914
    ##  2     2 agreeableness_t1 1.687102
    ##  3     3 agreeableness_t1 2.586287
    ##  4     4 agreeableness_t1 2.665519
    ##  5     5 agreeableness_t1 2.645352
    ##  6     6 agreeableness_t1 3.690846
    ##  7     7 agreeableness_t1 3.317954
    ##  8     8 agreeableness_t1 3.569045
    ##  9     9 agreeableness_t1 4.642243
    ## 10    10 agreeableness_t1 0.802873
    ## # ... with 1,990 more rows
...
time point.
    ...
    ##  * <dbl>         <chr> <chr>    <dbl>
    ##  1     1 agreeableness    t1 2.609914
    ##  2     2 agreeableness    t1 1.687102
    ##  3     3 agreeableness    t1 2.586287
    ##  4     4 agreeableness    t1 2.665519
    ##  5     5 agreeableness    t1 2.645352
    ##  6     6 agreeableness    t1 3.690846
    ##  7     7 agreeableness    t1 3.317954
    ##  8     8 agreeableness    t1 3.569045
    ##  9     9 agreeableness    t1 4.642243
    ## 10    10 agreeableness    t1 0.802873
    ## # ... with 1,990 more rows
...
it:
    ...
    ##  * <dbl>            <dbl>            <dbl>            <dbl>
    ##  1     1         2.609914         2.869869         3.688870
    ##  2     2         1.687102         2.519115         2.547279
    ##  3     3         2.586287         3.267412         3.897151
    ##  4     4         2.665519         3.104890         3.679109
    ##  5     5         2.645352         3.488426         3.805877
    ##  6     6         3.690846         4.064503         4.741169
    ##  7     7         3.317954         3.678660         4.314751
    ##  8     8         3.569045         4.156013         4.688154
    ##  9     9         4.642243         4.745785         5.477453
    ## 10    10         0.802873         1.534554         2.006622
...
`str()`
    ...
    ##  $ agreeableness    : num  2.61 2.87 3.69 4.19 1.69 ...
    ##  $ conscientiousness: num  3.09 3.66 4.43 4.55 3.77 ...
    ##  $ extraversion     : num  4.4 4.76 5.23 5.69 3.19 ...
    ##  $ neuroticism      : num  3.43 4.06 4.48 4.96 1.97 ...
    ##  $ openness         : num  3.6 3.92 4.58 5.48 2.84 ...
...
that into the pipeline.
    ...
    ##  * <dbl>            <dbl>                <dbl>           <dbl>
    ##  1     1         2.609914             3.090998        4.400030
    ##  2     2         1.687102             3.765265        3.185300
    ##  3     3         2.586287             3.199526        2.962318
    ##  4     4         2.665519             1.829241        3.868195
    ##  5     5         2.645352             2.093038        2.923214
    ##  6     6         3.690846             2.628725        3.437441
    ##  7     7         3.317954             3.504026        3.256630
    ##  8     8         3.569045             2.516557        3.210808
    ##  9     9         4.642243             3.054369        2.138354
    ## 10    10         0.802873             4.786069        3.655657
...
completeness, this is how it would work:
    ...
    ##  * <dbl> <chr>         <dbl>             <dbl>        <dbl>       <dbl>
    ##  1     1    t1      2.609914          3.090998     4.400030    3.433968
    ##  2     2    t1      1.687102          3.765265     3.185300    1.974373
    ##  3     3    t1      2.586287          3.199526     2.962318    2.938334
    ##  4     4    t1      2.665519          1.829241     3.868195    1.861557
    ##  5     5    t1      2.645352          2.093038     2.923214    3.055111
    ##  6     6    t1      3.690846          2.628725     3.437441    2.036853
    ##  7     7    t1      3.317954          3.504026     3.256630    1.598658
    ##  8     8    t1      3.569045          2.516557     3.210808    2.974917
    ##  9     9    t1      4.642243          3.054369     2.138354    3.968014
    ## 10    10    t1      0.802873          4.786069     3.655657    2.512915
...
-   `gather()` is great for lengthening data; I would recommend it over
    `reshape()` everytime.
-   `separate()` can be used to separate a column that really contains
    multiple pieces of information
-   `spread()` works for getting widening your data, but it can require
    some in between steps.
-   `gather()` can be used to combine information kept in two separate
    columns
    -   remember, this is a big one for getting data into wide format
        with tidyr and `spread()`
-   `reshape()` works really well for widening your data; I recommend it
    over `spread()` in most cases.
    -   the exception being when your dataset is already in a long (and
        really, the longest reasonable) format.
-   `reshape()` can be used to lengthen your data, but it's syntax is a
    little wonky
