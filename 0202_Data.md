...
that looks like this:
    ...
    ##    <dbl>            <dbl>                <dbl>          <dbl>
    ##  1     1         3.611770             2.983568       3.784894
    ##  2     2         1.988090             2.742685       2.513598
    ##  3     3         3.361393             3.545871       2.724867
    ##  4     4         4.160716             1.710146       3.808985
    ##  5     5         4.129195             3.202453       1.313210
    ##  6     6         1.958819             1.240036       1.283123
    ##  7     7         2.157975             2.921453       2.318724
    ##  8     8         3.753790             5.041249       2.274047
    ##  9     9         2.125708             2.813900       2.122662
    ## 10    10         2.586204             2.783992       3.455893
    ...
    ##  $ agreeableness_t1    : num  3.61 1.99 3.36 4.16 4.13 ...
    ##  $ conscientiousness_t1: num  2.98 2.74 3.55 1.71 3.2 ...
    ##  $ neuroticism_t1      : num  3.78 2.51 2.72 3.81 1.31 ...
    ##  $ extraversion_t1     : num  3.27 3.06 3.47 2.12 3.2 ...
    ##  $ openness_t1         : num  3.44 3.07 4.28 1.06 4.6 ...
    ##  $ agreeableness_t2    : num  4.02 2.52 3.91 4.61 4.16 ...
    ##  $ conscientiousness_t2: num  3.58 3.05 3.85 1.84 3.9 ...
    ##  $ neuroticism_t2      : num  4.41 2.96 3.28 3.85 1.87 ...
    ##  $ extraversion_t2     : num  3.42 3.63 3.61 2.89 3.62 ...
    ##  $ openness_t2         : num  4.03 3.78 4.56 1.86 5.26 ...
    ##  $ agreeableness_t3    : num  4.53 3.34 4.06 4.8 4.47 ...
    ##  $ conscientiousness_t3: num  4.24 3.3 4.4 2.39 4.47 ...
    ##  $ neuroticism_t3      : num  5.06 3.63 3.7 4.23 2.15 ...
    ##  $ extraversion_t3     : num  4.09 4.27 3.69 3.24 4.15 ...
    ##  $ openness_t3         : num  4.37 4.14 5.1 2.83 5.62 ...
    ##  $ agreeableness_t4    : num  4.85 3.5 4.94 5.4 5.05 ...
    ##  $ conscientiousness_t4: num  4.72 3.67 4.93 2.76 4.7 ...
    ##  $ neuroticism_t4      : num  5.64 3.82 4.29 4.64 2.8 ...
    ##  $ extraversion_t4     : num  4.47 4.8 4.12 3.74 4.6 ...
    ##  $ openness_t4         : num  5.09 4.68 5.56 3.15 6.28 ...
...
participant at each time point, like so:
    ...
    ##    <dbl> <chr>         <chr>    <dbl>
    ##  1     1    t1 agreeableness 3.611770
    ##  2     1    t2 agreeableness 4.016030
    ##  3     1    t3 agreeableness 4.529324
    ##  4     1    t4 agreeableness 4.845737
    ##  5     2    t1 agreeableness 1.988090
    ##  6     2    t2 agreeableness 2.522865
    ##  7     2    t3 agreeableness 3.341115
    ##  8     2    t4 agreeableness 3.496386
    ##  9     3    t1 agreeableness 3.361393
    ## 10     3    t2 agreeableness 3.909143
...
And say we want it to lengthen it to look like this:
    ...
    ##  1     1    t1      3.611770          2.983568     3.265249    3.784894
    ##  2     1    t2      4.016030          3.577319     3.424210    4.414877
    ##  3     1    t3      4.529324          4.237077     4.086536    5.061184
    ##  4     1    t4      4.845737          4.715021     4.470481    5.641554
    ##  5     2    t1      1.988090          2.742685     3.059519    2.513598
    ##  6     2    t2      2.522865          3.052193     3.625384    2.957580
    ##  7     2    t3      3.341115          3.298874     4.273785    3.627448
    ##  8     2    t4      3.496386          3.670617     4.802549    3.821221
    ##  9     3    t1      3.361393          3.545871     3.473832    2.724867
    ## 10     3    t2      3.909143          3.849642     3.614458    3.279228
...
but `pid`
    ...
    ##      pid         variable    score
    ##    <dbl>            <chr>    <dbl>
    ##  1     1 agreeableness_t1 3.611770
    ##  2     2 agreeableness_t1 1.988090
    ##  3     3 agreeableness_t1 3.361393
    ##  4     4 agreeableness_t1 4.160716
    ##  5     5 agreeableness_t1 4.129195
    ##  6     6 agreeableness_t1 1.958819
    ##  7     7 agreeableness_t1 2.157975
    ##  8     8 agreeableness_t1 3.753790
    ##  9     9 agreeableness_t1 2.125708
    ## 10    10 agreeableness_t1 2.586204
    ## # ... with 1,990 more rows
...
time point.
    ...
    ##  * <dbl>         <chr> <chr>    <dbl>
    ##  1     1 agreeableness    t1 3.611770
    ##  2     2 agreeableness    t1 1.988090
    ##  3     3 agreeableness    t1 3.361393
    ##  4     4 agreeableness    t1 4.160716
    ##  5     5 agreeableness    t1 4.129195
    ##  6     6 agreeableness    t1 1.958819
    ##  7     7 agreeableness    t1 2.157975
    ##  8     8 agreeableness    t1 3.753790
    ##  9     9 agreeableness    t1 2.125708
    ## 10    10 agreeableness    t1 2.586204
    ## # ... with 1,990 more rows
...
it:
    ...
    ##  * <dbl>            <dbl>            <dbl>            <dbl>
    ##  1     1         3.611770         4.016030         4.529324
    ##  2     2         1.988090         2.522865         3.341115
    ##  3     3         3.361393         3.909143         4.063218
    ##  4     4         4.160716         4.609574         4.801028
    ##  5     5         4.129195         4.157485         4.473531
    ##  6     6         1.958819         2.422145         2.783692
    ##  7     7         2.157975         2.607611         2.981735
    ##  8     8         3.753790         4.534093         5.096415
    ##  9     9         2.125708         2.641108         3.372769
    ## 10    10         2.586204         2.977554         3.307085
...
`str()`
    ...
    ##  $ agreeableness    : num  3.61 4.02 4.53 4.85 1.99 ...
    ##  $ conscientiousness: num  2.98 3.58 4.24 4.72 2.74 ...
    ##  $ extraversion     : num  3.27 3.42 4.09 4.47 3.06 ...
    ##  $ neuroticism      : num  3.78 4.41 5.06 5.64 2.51 ...
    ##  $ openness         : num  3.44 4.03 4.37 5.09 3.07 ...
...
that into the pipeline.
    ...
    ##  * <dbl>            <dbl>                <dbl>           <dbl>
    ##  1     1         3.611770             2.983568       3.2652493
    ##  2     2         1.988090             2.742685       3.0595194
    ##  3     3         3.361393             3.545871       3.4738324
    ##  4     4         4.160716             1.710146       2.1150731
    ##  5     5         4.129195             3.202453       3.2031697
    ##  6     6         1.958819             1.240036       2.0291486
    ##  7     7         2.157975             2.921453       3.5918470
    ##  8     8         3.753790             5.041249       1.9431670
    ##  9     9         2.125708             2.813900       4.3824528
    ## 10    10         2.586204             2.783992       0.8185013
...
completeness, this is how it would work:
    ...
    ##      pid  time agreeableness conscientiousness extraversion neuroticism
    ##  * <dbl> <chr>         <dbl>             <dbl>        <dbl>       <dbl>
    ##  1     1    t1      3.611770          2.983568    3.2652493    3.784894
    ##  2     2    t1      1.988090          2.742685    3.0595194    2.513598
    ##  3     3    t1      3.361393          3.545871    3.4738324    2.724867
    ##  4     4    t1      4.160716          1.710146    2.1150731    3.808985
    ##  5     5    t1      4.129195          3.202453    3.2031697    1.313210
    ##  6     6    t1      1.958819          1.240036    2.0291486    1.283123
    ##  7     7    t1      2.157975          2.921453    3.5918470    2.318724
    ##  8     8    t1      3.753790          5.041249    1.9431670    2.274047
    ##  9     9    t1      2.125708          2.813900    4.3824528    2.122662
    ## 10    10    t1      2.586204          2.783992    0.8185013    3.455893
